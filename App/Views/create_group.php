    ...
    layui.use('upload', function(){
        ...
        upload.render({
            ...
            ,done: function(res, index, upload){
                ...
                if (res.code == 0){
                    $('#yl').attr('src','<?=$server?>'+res.data.src).show();
                    $('input[name="avatar"]').val('<?=$server?>'+ res.data.src);
                }else{
            ...
            $.ajax({
                ...
                success:function(res){
                    if (res.code == 200) {
                        ...
                        setTimeout(function () {
                            parent.location.href="/admin/main/find?type=group";
                        },1500);
                    }else{
                        layer.msg(res.msg,function(){});
                    }
