...
<script>
    ...
    function findUser() {
        wd = $('#user-wd').val();
        window.location.href="/admin/main/find?type=user&wd="+ wd
    }

    // 查找群组
    function findGroup() {
        wd = $('#group-wd').val();
        window.location.href="/admin/main/find?type=group&wd="+ wd
    }
    ...
    function createGroup() {
        layer.open({
            ...
            shade: 0.8,
            area: ['40%', '90%'],
            content: '/admin/main/createGroup'
        });
    }
</script>
</body>
