        ...
        $.ajax({
            ...
            success:function (res) {
                if (res.code == 200){
                    ...
                    parent.sendMessage(parent.socket,JSON.stringify({
                        action:"refuseFriend",
                        params:{
                            id:id
                        }
    ...
    function agree(id,obj,avatar,nickname){
        ...
        parent.layui.layim.setFriendGroup({
            ...
            ,submit: function(group, index){
                ...
                $.ajax({
                    url:"<?=$server?>/User/addFriend",
                    type:"post",
                    data:{id:id,groupid:group,token:'<?=$token?>'},
                    dataType:"json",
                    success:function (res) {
                        console.log(res)
                        //执行添加好友操作
